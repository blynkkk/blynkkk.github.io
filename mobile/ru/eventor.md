...
Обработчик событий также поддерживает события [Таймера (Timer)](https://github.com/blynkkk/blynkkk.github.io/blob/master/mobile/ru/timer.md). Например, вы можете установить пин ```V1``` ON/HIGH в 21:00:00 каждую пятницу.
...
**ПРИМЕЧАНИЕ:** Виджет [Таймера](https://github.com/blynkkk/blynkkk.github.io/blob/master/mobile/ru/timer.md) зависит от времени сервера, а не вашего телефона. Иногда время телефона может не соответствовать времени сервера.
